...
local awesome_overrides = function(theme)
    ...
    theme.taglist_bg_occupied =
        'linear:0,0:' .. dpi(left_bar_width) .. ',0:0,' .. '#c4755c' .. ':0.08,' ..
            '#c4755c' .. ':0.08,' .. theme.background.hue_800 .. ':1,' ..
            theme.background.hue_800
    theme.taglist_bg_urgent = 'linear:0,0:' .. dpi(left_bar_width) .. ',0:0,' ..
                                  theme.accent.hue_500 .. ':0.08,' ..
                                  theme.accent.hue_500 .. ':0.08,' ..
                                  theme.background.hue_800 .. ':1,' ..
                                  theme.background.hue_800
    theme.taglist_bg_focus = 'linear:0,0:' .. dpi(left_bar_width) .. ',0:0,' ..
                                 theme.fg_normal .. ':0.08,' .. theme.fg_normal ..
                                 ':0.08,' .. theme.background.hue_800 .. ':1,' ..
                                 theme.background.hue_800
    ...
    theme.tasklist_bg_focus = 'linear:0,0:0,' .. dpi(top_bar_width) .. ':0,' ..
