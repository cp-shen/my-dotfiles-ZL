...
end), awful.button({}, 4, awful.tag.viewprev),
                           awful.button({}, 5, awful.tag.viewnext)))
-- }}}

-- {{{ Key bindings
globalkeys = my_table.join( -- focus control
awful.key({modkey}, "j", function()
    awful.client.focus.global_bydirection("down")
    if client.focus then client.focus:raise() end
end, {description = "focus down", group = "focus control"}),

awful.key({modkey}, "k", function()
    awful.client.focus.global_bydirection("up")
    if client.focus then client.focus:raise() end
end, {description = "focus up", group = "focus control"}),

awful.key({modkey}, "h", function()
    awful.client.focus.global_bydirection("left")
    if client.focus then client.focus:raise() end
end, {description = "focus left", group = "focus control"}),

awful.key({modkey}, "l", function()
    awful.client.focus.global_bydirection("right")
    if client.focus then client.focus:raise() end
end, {description = "focus right", group = "focus control"}),
...
end, {description = "launch rofi: run apps", group = "launcher"}),

awful.key({modkey}, "Tab", function()
    awful.spawn("/usr/bin/rofi -show window -modi window")
end, {description = "launch rofi: window list", group = "launcher"}),
...
awful.key({modkey, "Control", "Shift"}, "q", awesome.quit,
          {description = "quit awesome", group = "awesome hotkeys"}), -- help
awful.key({modkey, "Control", "Shift"}, "h", hotkeys_popup.show_help,
          {description = "show help", group = "awesome hotkeys"}), -- show menu
...
end, {description = "toggle wibox", group = "awesome hotkeys"}),
...
awful.key({modkey}, "t",
          function() awful.layout.set(awful.layout.layouts[2]) end,
          {description = "use tile layout", group = "layout"}),
awful.key({modkey}, "q",
          function() awful.layout.set(awful.layout.layouts[3]) end,
...
awful.key({modkey, "Control", "Shift"}, "l", function()
    ...
    os.execute("slock")
end, {description = "lock screen", group = "sys hotkeys"}), -- suspend
awful.key({modkey, "Control", "Shift"}, "s",
          function() os.execute("systemctl suspend") end,
...
end, {description = "volume up", group = "sys hotkeys"}),

awful.key({modkey, altkey}, "Down", function()
    os.execute(string.format("amixer -q set %s 5%%-", beautiful.volume.channel))
    beautiful.volume.update()
end, {description = "volume down", group = "sys hotkeys"}),
...
awful.key({modkey, altkey}, "m", function()
    ...
    beautiful.volume.update()
end, {description = "toggle mute", group = "sys hotkeys"}),
...
awful.key({}, "XF86AudioMute", function()
    os.execute(string.format("amixer -q set %s toggle", beautiful.volume
                                 .togglechannel or beautiful.volume.channel))
    beautiful.volume.update()
end, {description = "toggle mute", group = "sys hotkeys"}), -- Standard program
...
awful.key({modkey}, "r",
          ...
          {description = "run prompt", group = "launcher"}) -- awful.key({ modkey }, "x",
-- function ()
-- awful.prompt.run {
-- prompt       = "Run Lua code: ",
...
clientkeys =
    my_table.join( -- awful.key({ altkey, "Shift"   }, "m",      lain.util.magnify_client,
...
client.connect_signal("unmanage", function(c) end)
